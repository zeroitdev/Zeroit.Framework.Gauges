...
namespace Zeroit.Framework.Gauges.Anidaso.Helper
{
    /// <summary>
    /// Class GaugeColorTransition.
    /// </summary>
    /// <seealso cref="System.ComponentModel.Component" />
    [ToolboxItem(false)]
    public class GaugeColorTransition : Component
    {
        /// <summary>
        /// The int 0
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GaugeColorTransition"/> class.
        /// </summary>
        public GaugeColorTransition()
        {
            this.method_1();
        }
        ...
        public GaugeColorTransition(IContainer container)
        {
            container.Add(this);
            this.method_1();
        }
        ...
        private void method_0()
        {
            ...
            int num1 = 0;
            int num2;
            Color colorScale = getColorScale(this.ProgessValue, this.Color1, this.Color2);
